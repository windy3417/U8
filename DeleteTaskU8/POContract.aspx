...
<asp:Content ID="contentTools" ContentPlaceHolderID="ContentPlaceHolderForTools" runat="server">
    
</asp:Content>
<asp:Content ID="contentFilter" ContentPlaceHolderID="filter"  runat="server">
   <div class="filterBox"  style="margin:20px;">
        ...
        <div class="divVendor">
             ...
             <div>
                   <div>
                        <asp:Label ID="lblVendor"  runat="server" Text="供应商编码"></asp:Label>
                 <%-- btn与textBox在一个框中，但textBox并非容器 --%>
                       <div class="divReferenceTextBox" style="display:flex;direction:ltr; width:230px;height:26px;">
                               <asp:TextBox ID="txtVendor" margin-right="0" Width="200px" Height="20px" runat="server" > </asp:TextBox>
                               <asp:Button ID="btnVenddorReference" runat="server" width="25px" marging="0" Height="26px" 
                                   PostBackUrl="~/view/filterForm/filterVendorArchive.aspx" Text="..." OnClick="btnVenddorReference_Click" />
                       </div> 
        ...
        <asp:Button ID="Button1"  PostBackUrl="~/view/filterForm/filterVendorArchive.aspx"  
